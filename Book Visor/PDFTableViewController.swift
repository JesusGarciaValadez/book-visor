...
//  Book Visor
//
//  Created by Jesús García Valadez on 04/09/16.
...
class PDFTableViewController: UITableViewController {
  ...
  let pdf : [ String ] = [ "pdf_1", "pdf_2", "pdf_3", "pdf_4" ]
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
      ...
      // Configure the cell...
      cell.textLabel!.text = self.pdf[ indexPath.row ]
    ...
    */
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
      ...
      if let indexSelected = sender as! UITableViewCell? {
        let webViewController : WebViewController = segue.destination as! WebViewController
        webViewController.fileName = indexSelected.textLabel!.text!
      }
    }
}
